...
class Property_Map_Plugin
{
    ...
    {
        $this->google_maps_api_key = 'xxxxxxxxxxxxxxxxxxxxxxxxxxxx';
...
?>
    ...
    /**
     * Retrieves the property map location.
     *
     * This function queries the database to fetch properties and collects location data for markers. It fetches latitude and longitude from the ACF group field 'coordinates' and creates marker information if the location data exists.
     *
     * @throws None
     * @return None
     */
    public function get_property_map_location()
    {
        if (!empty($this->markers)) return;
    ...
    public function property_map_script(): void
    {
        ...
        Property_Map_Plugin::get_property_map_location();
    ...
    ?>
        <script type="text/javascript">
            function initPropertyMap() {
                ...
                var customIcon = {
                    url: '/wp-content/uploads/2024/01/pin.png',
                };
                ...
                markers.forEach(function(markerInfo) {
                    ...
                    var infowindow = new google.maps.InfoWindow({
                        content: '<a href="' + markerInfo.permalink + '" class="read-more-button"><h5 style = "color:black;">' + markerInfo.title + '</h5></a><a href="javascript:void(0);" class="read-more-button">Read More</a>',
                    });
